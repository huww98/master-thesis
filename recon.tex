...
在计算人脸模型的可见性梯度时，人脸模型裁剪时产生的人为制造的边缘在照片中并无对应，会产生错误的梯度。
...
\paragraph{实现细节}
该实验过程使用PyTorch\citep{pytorch}和nvdiffrast实现。
长度单位为毫米。
本文使用Adam\citep{adam}优化器，光照参数、3DMM模型参数、平移量、旋转量、顶点偏移量的学习率分别为$10^{-2}$、$10^{-2}$、$10^{-2}$、$10^{-4}$、$10^{-3}$，其余参数为默认值。
可见性梯度扩展项的系数为$\alpha=10^{-7}$。
3DMM系数，顶点偏移、拉普拉斯、环境光照、光照修正场强度、梯度的正则项系数分别为
$10^{-5}$、$10^{-9}$、$40$、$10^{-6}$、$10^{-3}$、$10^{-3}$。
逆渲染的分辨率为$1024\times1024$，运行了1000次优化迭代。
本实现在NVIDIA RTX3060显卡上，单张照片的逆渲染优化约需要20秒。
...
\centering
    \begin{tikzpicture}[
        ...
        \node (a) [image] {\includegraphics[width=1.05in]{figures/diffrast_face/00015/target_hs}};
        \node (b) [image,right=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/00015/initial}};
        \node (c) [image,right=of b] {\includegraphics[width=1.05in]{figures/diffrast_face/00015/final_rerendered}};
        \node (d) [image,right=of c] {\includegraphics[width=1.05in]{figures/diffrast_face/00015/final_rot_rerendered}};
        \node (e) [image,right=of d] {\includegraphics[width=1.05in]{figures/diffrast_face/00015/final_geo_rerendered}};
        \node (f) [image,right=of e] {\includegraphics[width=1.05in]{figures/diffrast_face/00015/relight}};

        \node (a) [image,below=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/00029/target_hs}};
        \node (b) [image,right=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/00029/initial}};
        \node (c) [image,right=of b] {\includegraphics[width=1.05in]{figures/diffrast_face/00029/final_rerendered}};
        \node (d) [image,right=of c] {\includegraphics[width=1.05in]{figures/diffrast_face/00029/final_rot_rerendered}};
        \node (e) [image,right=of d] {\includegraphics[width=1.05in]{figures/diffrast_face/00029/final_geo_rerendered}};
        \node (f) [image,right=of e] {\includegraphics[width=1.05in]{figures/diffrast_face/00029/relight}};

        \node (a) [image,below=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/00017/target_hs}};
        \node (b) [image,right=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/00017/initial}};
        \node (c) [image,right=of b] {\includegraphics[width=1.05in]{figures/diffrast_face/00017/final_rerendered}};
        \node (d) [image,right=of c] {\includegraphics[width=1.05in]{figures/diffrast_face/00017/final_rot_rerendered}};
        \node (e) [image,right=of d] {\includegraphics[width=1.05in]{figures/diffrast_face/00017/final_geo_rerendered}};
        \node (f) [image,right=of e] {\includegraphics[width=1.05in]{figures/diffrast_face/00017/relight}};

        \node (a) [image,below=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/04114/target_hs}};
        \node (b) [image,right=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/04114/initial}};
        \node (c) [image,right=of b] {\includegraphics[width=1.05in]{figures/diffrast_face/04114/final_rerendered}};
        \node (d) [image,right=of c] {\includegraphics[width=1.05in]{figures/diffrast_face/04114/final_rot_rerendered}};
        \node (e) [image,right=of d] {\includegraphics[width=1.05in]{figures/diffrast_face/04114/final_geo_rerendered}};
        \node (f) [image,right=of e] {\includegraphics[width=1.05in]{figures/diffrast_face/04114/relight}};

        \node (a) [image,below=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/04038/target_hs}};
        \node (b) [image,right=of a] {\includegraphics[width=1.05in]{figures/diffrast_face/04038/initial}};
        \node (c) [image,right=of b] {\includegraphics[width=1.05in]{figures/diffrast_face/04038/final_rerendered}};
        \node (d) [image,right=of c] {\includegraphics[width=1.05in]{figures/diffrast_face/04038/final_rot_rerendered}};
        \node (e) [image,right=of d] {\includegraphics[width=1.05in]{figures/diffrast_face/04038/final_geo_rerendered}};
        \node (f) [image,right=of e] {\includegraphics[width=1.05in]{figures/diffrast_face/04038/relight}};
...
但是，作为一个传统优化算法，在巨大的解空间下，其鲁棒性上并不如神经网络的结果，特别是容易产生意外的小几何结构，例如在图\ref{fig:rerender}中的第一行中，鼻梁左侧出现了一个尖锐的突起，导致了明显的亮点。
...
同时，正脸部分毛孔和胡须的细节也被很好地保留了下来，两侧从照片中看不到的部分也被很好地补全了。
这说明了本文使用的纹理补全方法的有效性。
