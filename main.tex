...
\keyword{关键词：} \changed{人脸扫描}；可微分渲染；逆渲染；SDF贴图；人脸重建
...
\keyword{Keywords:} \changed{Face scanning}; Differentiable rendering; Inverse rendering; SDF maps; Face reconstruction
